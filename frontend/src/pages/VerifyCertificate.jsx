  ...
  if (error) {
    return (
      <div className="py-5 d-flex justify-content-center px-3">
        <div className="card bg-dark text-light border-secondary shadow-lg text-center p-5 rounded-4" style={{ maxWidth: "500px", width: "100%" }}>
          <div className="mb-3">
          ...
          <div>
            <Link to="/" className="btn btn-warning px-4 rounded-pill mt-3 text-dark fw-semibold">
              Return Home
            </Link>
          </div>
        </div>
      ...
      <div className="container" style={{ maxWidth: "860px" }}>
        ...
        <div className="bg-dark border border-secondary border-opacity-50 rounded-3 p-3 shadow-sm mb-4 d-flex align-items-center justify-content-between flex-wrap gap-2">
          ...
          <div className="text-end">
            <span className="text-light-50 small d-block" style={{ fontSize: "0.75rem", color: "#a0a0a0" }}>Verification ID</span>
            <code className="text-warning fw-semibold small">{certificate.certificateCode}</code>
          </div>
        </div>
        ...
        >
          ...
          <div 
            ...
            style={{ border: "2px solid #ea580c", outline: "1px solid rgba(234, 88, 12, 0.3)", outlineOffset: "4px" }}
          >
            ...
            <div className="text-center mb-4">
              ...
              <h1 
                ...
                style={{ fontFamily: "'Times New Roman', Georgia, serif", color: "#0f172a" }}
              >
                Certificate of Achievement
              </h1>
              <p className="text-muted fst-italic small">This is to certify that</p>
            </div>
            ...
            <div className="text-center my-4">
              <h2 
                ...
                style={{ fontFamily: "'Times New Roman', Georgia, serif", color: "#ea580c" }}
              >
                {certificate.candidate.name}
              </h2>
              <span className="text-muted small d-block mt-1">{certificate.candidate.email}</span>
              <div className="mx-auto mt-2" style={{ width: "100px", height: "3px", backgroundColor: "#f97316" }}></div>
            </div>

            {/* Assessment Title */}
            <div className="text-center mx-auto mb-4" style={{ maxWidth: "550px" }}>
            ...
            <div className="rounded-3 p-3 my-4 border" style={{ backgroundColor: "#f8fafc", borderColor: "#e2e8f0" }}>
              <div className="row text-center g-2 align-items-center">
                <div className="col-4">
                  <span className="text-uppercase text-muted d-block fw-semibold" style={{ fontSize: "0.65rem", letterSpacing: "1px" }}>
                    Score
                  </span>
            ...
            <div className="row align-items-end mt-4 pt-3 border-top" style={{ borderColor: "#e2e8f0" }}>
              <div className="col-6 text-start">
                <span className="text-uppercase text-muted d-block" style={{ fontSize: "0.65rem", letterSpacing: "1px" }}>
                  Date Issued
                </span>
        ...
        <div className="text-center mt-4 d-print-none">
          ...
          <Link to="/" className="btn btn-outline-light rounded-pill px-4 fw-medium">
            Back
          </Link>
        </div>
